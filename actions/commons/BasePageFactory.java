...
public class BasePageFactory {
	...
	public void backToPrePage(WebDriver driver) {
	...
	public void selectItemInCustomDropdown(WebDriver driver, WebElement parentElement, String childrenXpathLocator,
			String selectedItem) {
		clickToElement(driver, parentElement);
		sleepInSecond(1);
		WebDriverWait explicitWait = new WebDriverWait(driver, longTimeout);
		explicitWait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(getByXpath(childrenXpathLocator)));
		List<WebElement> list = driver.findElements(By.cssSelector(childrenXpathLocator));
	...
	public void waitForElementInvisible(WebDriver driver, List<WebElement> elements) {
		WebDriverWait explicitWait=new WebDriverWait(driver, longTimeout);
